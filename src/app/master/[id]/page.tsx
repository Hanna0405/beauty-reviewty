    ...
    <div className="mx-auto max-w-3xl p-6">
      ...
      <div className="flex gap-4 rounded-lg border p-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-sm text-gray-600"><SafeText value={data?.city?.cityName ?? data?.city?.formatted ?? data?.city} /></div>
          <div className="mt-1 text-sm"><SafeText value={data.services} /></div>
          <div className="text-xs text-gray-500"><SafeText value={data.languages} /></div>
