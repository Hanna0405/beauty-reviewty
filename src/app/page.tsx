  ...
  return (
    <main className="container mx-auto px-4 py-8 space-y-10">
      ...
      <section className="container mx-auto px-4 mt-6 md:mt-10">
        <div className="rounded-3xl shadow-sm border border-rose-100 overflow-hidden
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-6 md:gap-8 p-5 md:p-8">
            ...
            <div className="md:basis-1/2 flex flex-col justify-center">
              ...
              <p className="mt-2 text-rose-700/80">
                Search by city, services, and language. Read real reviews with photos.
              </p>
              <div className="mt-4 flex gap-3">
                <a href="/masters" className="px-4 py-2 rounded-lg bg-rose-600 text-white hover:bg-rose-700 transition">
                  Browse Masters
                </a>
                <a href="/reviewty" className="px-4 py-2 rounded-lg bg-rose-200 text-rose-800 hover:bg-rose-300 transition">
                  Reviewty
                </a>
              </div>
            </div>
      ...
      <section className="container mx-auto px-4 mt-4 md:mt-6">
        <BannerExtrasClient showSearch={false} showCategories={true} showCta={false} />
      </section>
