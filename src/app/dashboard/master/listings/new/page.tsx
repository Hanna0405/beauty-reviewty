            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Add a new service listing to showcase your work
                </p>
              </div>
              <button
                onClick={() => router.back()}
            ...
            {errorMsg && (
              <div className="mb-4 rounded-lg border border-rose-200 bg-rose-50 px-3 py-2 text-rose-800">
                <div className="flex items-start gap-2">
                  <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-rose-600 text-white text-xs">
                    !
                  </span>
            ...
            <form className="space-y-6" onSubmit={onSubmit}>
              ...
              {successId && (
                <div className="mt-4 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-emerald-800">
                  <div className="flex items-start gap-2">
                    <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-emerald-600 text-white text-xs">
                      ✓
                    </span>
                    <div className="text-sm">
                      ...
                      <div className="mt-0.5">
                        <a
                          href={`/masters/${successId}`}
                          className="underline underline-offset-2 decoration-emerald-600 hover:text-emerald-700"
                        >
                          Open listing →
                        </a>
                      </div>
