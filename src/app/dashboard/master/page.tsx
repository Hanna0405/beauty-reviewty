  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Calendar Card */}
        <Link href="/dashboard/master/calendar" className="group">
          <div className="bg-white rounded-lg border p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
        ...
        {/* Bookings Card */}
        <Link href="/dashboard/master/bookings" className="group">
          <div className="bg-white rounded-lg border p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
            ...
            <p className="text-gray-600 text-sm">Handle incoming booking requests</p>
          </div>
        </Link>

        {/* Chat Card */}
        <Link href="/dashboard/master/chat" className="group">
          <div className="bg-white rounded-lg border p-6 hover:shadow-md transition-shadow">
            <div className="flex items-center justify-between mb-4">
