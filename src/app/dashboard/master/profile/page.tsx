      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {profile ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">No Profile Yet</h2>
            <p className="text-gray-600 mb-8 max-w-md mx-auto">
              You haven't created your master profile yet. Create one to showcase your services and connect with clients.
            </p>
            <button
              onClick={handleCreateProfile}
              className="bg-pink-600 text-white px-6 py-3 rounded-md font-medium hover:bg-pink-700 transition-colors flex items-center mx-auto"
            >
